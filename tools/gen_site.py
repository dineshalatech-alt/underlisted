 ...
 *{{box-sizing:border-box;-webkit-tap-highlight-color:transparent}}
 ...
 .stage{{position:relative;width:min(590px,92vw);height:min(590px,92vw);margin:48px auto 10px}}
 ...
 .hub{{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);
   width:132px;height:132px;border-radius:50%;display:grid;place-items:center;z-index:6;
   cursor:pointer;border:0;padding:0;background:transparent}}
 .hub .glow{{position:absolute;inset:-34px;border-radius:50%;
 ...
 .hub .disc{{position:relative;width:132px;height:132px;border-radius:50%;
 ...
 .hub .disc .num{{font-family:"Cormorant Garamond",serif;font-weight:600;font-size:2.3rem;line-height:1;color:#127A4A}}
 .hub .disc .lbl{{font-family:"Inter";font-weight:700;font-size:.52rem;letter-spacing:.16em;
